...
function(e) {
  ...
  3 : function(e, t) {
    ...
    r = function() {
      return n.get(["v"], (function(e) { (512 | e.v) == e.v ? localStorage[0] = localStorage.cur = "random": "random" == localStorage.cur && n.set({
          s: o(localStorage.cur = "default")
        }),
        document.querySelector("#cur").innerText = localStorage.cur || "default",
        document.querySelectorAll("fieldset").forEach((function(e) {
    ...
    window.onload = function() {
      ...
      document.querySelectorAll("fieldset").forEach((function(e) {
        ...
        e.onclick = function(e) {
          return n.get(["v"], (function(e) {
            localStorage.cur = localStorage[t.value] || "default",
            "0" !== t.value ? ((512 | e.v) == e.v && n.set({
              v: 512 ^ e.v
            }), n.set({
      ...
      document.querySelectorAll(".seed").forEach((function(e) {
        ...
        e.oninput = e.onchange = function(t) {
          return n.set({
