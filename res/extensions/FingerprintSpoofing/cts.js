...
function(t) {
  ...
  var n = function(t) {
    ...
    if (o(1, ["toDataURL",  "getLineDash", "toBlob", "getImageData","measureText"]), 
				o(2, ["readPixels", "bufferData", "getParameter"]), 
				o(4, ["getChannelData", "getFloatFrequencyData"]), 
				o(8, ["offsetWidth", "offsetHeight"]), 
				o(16, ["getBattery", "getGamepads", "getVRDisplays", "screen", "plugins", "mimeTypes", "platform", "language", "languages"]), 
				o(32, ["enumerateDevices", "MediaStreamTrack", "RTCPeerConnection", "RTCSessionDescription", "webkitMediaStreamTrack", "webkitRTCPeerConnection", "webkitRTCSessionDescription"]), 
				o(64, ["getClientRects"]), 
				o(128, ["getTimezoneOffset", "resolvedOptions"]), 
				o(256, ["logs"]), 
				e.s = (512 | e.v) == e.v ? Math.random() : parseFloat(e.s), !window[r]) {
      var i = function(t) {
        return Math.floor(e.s * t)
      },
      a = function() {
        return e.i % e.c == 0 && (e.i = 1, e.n.push(e.c = e.n.shift())),
        e.r % e.c == e.i++?1 : 0
      };
      Object.assign(e, {
        i: 0,
      ...
      var u = function(t) {
        ...
        return u((function(r) {
          ...
          f = function(t) { !
            function(t, n) {
              if (e.logs) {
                var r = {};
                r[t] = n,
                window.dispatchEvent(new CustomEvent(e.g, {
                  detail: r
                }))
              }
          ...
          n(r.CanvasRenderingContext2D.prototype, {
            ...
            getLineDash: function(t) {
              ...
              return f(this.canvas),
              getLineDash.apply(this, arguments)
            })),
        ...
        u((function(t) {
          return n = t.HTMLElement.prototype,
          r = {
  ...
  if (globalThis.chrome && chrome.storage) {
    ...
    i = function(t) {
      return r.get(["v", "s", "g"], (function(t) {
        if (null == t.g) r.set({
          ...
          a.src = chrome.runtime.getURL("cts.js"),
          a.onload = function(t) {
            return window.dispatchEvent(new CustomEvent("memade", {
              detail: e
            }))
          },
    ...
    window.addEventListener("memade", (function t(e) {
      var r = e.detail;
      n(r),
      window.removeEventListener("memade", t)
    }))
  }
}]);